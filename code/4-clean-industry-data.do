...
//summarize by MSA
collapse (sum) total_funding federal_funding ffrdc_count annual_avg_estabs_count annual_avg_emplvl total_annual_wages, by(industry_code msacode msatitle msatype year)
